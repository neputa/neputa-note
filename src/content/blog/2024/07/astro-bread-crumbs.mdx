...
modDate: 2024-07-21T15:54:36.166Z
...
import { Breadcrumbs } from 'astro-breadcrumbs' // [!code ++]
import 'astro-breadcrumbs/breadcrumbs.css' // [!code ++]
---
...
{
  "devDependencies": {
    "astro-breadcrumbs": "^2.3.1", // [!code --]
    "astro-breadcrumbs": "git+https://github.com/neputa/astro-breadcrumbs-fork.git" // [!code ++]
  }
}
```
